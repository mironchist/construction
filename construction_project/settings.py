...
SECRET_KEY = os.getenv('DJANGO_SECRET_KEY', 'django-insecure-=5l(865=pkiud3cz&ti(zk)+_p+c!=mv#bcm2v1q_c**a1^z*w')
...
if os.getenv('DATABASE_URL'):
    # Настройки для продакшн (PostgreSQL)
...
STATIC_ROOT = BASE_DIR / 'staticfiles'  # Куда собирать статические файлы при деплое
